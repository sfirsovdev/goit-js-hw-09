...
//стиль кнопок
refs.btnStart.style = (`color: white; border-radius: 30%; background: green;cursor: pointer;`);
refs.btnStop.style = (`color: white; border-radius: 30%; background: red;cursor: pointer;`) 
